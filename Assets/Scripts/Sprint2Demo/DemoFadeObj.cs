...
public class DemoFadeObj : MonoBehaviour {
    ...
    void Start() {
      ...
      this.transition = this.gameObject.GetComponentInChildren<Animator>();
      
      TXDemoManager.GetScenes().SetAnimator(this.transition);
    }
